...
export default function CreateTodo({create}: {create: (todo: NewTodo) => void}) {
    ...
    <div>
        <Sheet>
            ...
            <SheetContent>
                ...
                <SheetTitle className='tracking-hughJanus text-center font-mono text-2xl uppercase' style={{letterSpacing: '.5em'}}>New Todo</SheetTitle>
                </SheetHeader>
                <form onSubmit={(e)=>{
                    e.preventDefault();
                    create(inputs);
